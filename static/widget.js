...
function main() { 
    jQuery(document).ready(function($) { 
      ...
      var whtml = "<div class=\"tuva_wbox\" id=\"tuva_wcontainer\"><div class=\"tuva_wmaintitle\"><div style=\"float:right\">Powered by: TuvaLabs</div></div><div class=\"tuva_wbody\">  <div class=\"tuva_wqsnbox\"><div class=\"tuva_wqsntitle\"><p>Math in the news</p></div><div class=\"tuva_qbody\"><div class=\"tuva_wqsn\"></div><div class=\"tuva_error\"></div><div class=\"tuva_woptions\"><form method=\"POST\" action=\"\" id=\"tuva_form\"><div class=\"tuva_formfields\"></div></form></div></div></div><div class=\"tuva_wfooter\"><span class=\"tuva_hints\">Hints<div class=\"tuva_hintsbox\"></div></span><span class=\"tuva_feedback\">Feedback<div class=\"tuva_feedbackbox\"><p>Please share your feedback at <a href=\"mailto:hello@tuvalabs.com\">hello@tuvalabs.com</a></p></div></span><span class=\"tuva_i\">i</span></div></div><style type=\"text/css\">.tuva_wbox{width:400px;max-height:300px;font-family: 'Source Sans Pro',sans-serif;text-align:justify;}.tuva_wmaintitle{padding:0px 5px;width:360px;height:25px;padding:0px 0px 0px 5px;}.tuva_wbody{width:360px;border:2px #000 solid;position:relative;min-height:250px;}.tuva_wqsnbox{width:360px;position:relative;}.tuva_qbody{margin-bottom:10px;max-height:250px;overflow:auto;min-height:250px;}.tuva_wqsntitle{width:355px;height:25px;border-bottom:2px #000 solid;padding-left:5px;}.tuva_wqsn{padding:5px 0px 0px 10px; width:320px;}.tuva_hintsbox {display:none;bottom:0px;width:280px;background:#cdcdcd;margin:10px 0px 20px 10px; padding:15px 20px;position:absolute;}.tuva_woptions{padding:0px 0px 0px 5px; width:320px;}.tuva_feedbackbox {bottom:0px;position:absolute; width:280px;background:#cdcdcd; margin:10px 0px 30px 10px; padding:10px; display:none;}.tuva_wfooter{border-top:2px #000 solid;height: 30px;}.tuva_hints{border-right:1px #000 solid;padding:2px 20px 0px 20px; line-height: 30px;}.tuva_feedback{border-right:1px #000 solid;padding:2px 60px 0px 60px;line-height: 30px;}.tuva_error{ padding:0px 0px 0px 10px; margin-bottom:10px;color: #FF0000; }.tuva_successmsg{ width:280px;background:#cdcdcd; margin:10px 0px 20px 10px; padding:15px 20px; }.tuva_formfields{float: right;}</style>";
